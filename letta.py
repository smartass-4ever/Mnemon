"""
Mnemon Letta Adapter
Translates Letta/MemGPT concepts into Mnemon signals.
...
class LettaAdapter(TemplateAdapter):
    ...
    Translates:
    - Letta agent steps → Mnemon ExecutionTemplate segments
    - Letta core_memory → Mnemon semantic memory
    - Letta archival_memory → Mnemon episodic memory
    - Letta heartbeat → Mnemon experience signal + PAD health report
    """
    ...
    def core_memory_to_signal(
        ...
        """
        Translate a Letta core_memory_replace into Mnemon semantic memory.
    ...
    def archival_insert_to_signal(
        ...
        """
        Translate a Letta archival_memory_insert into Mnemon episodic memory.
    ...
    def sleep_time_signals(
        ...
        Mnemon uses this window to write memory signals that were
