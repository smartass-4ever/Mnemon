...
Run: pytest tests/test_eros.py -v
or:  python tests/test_eros.py
"""
...
from eros import EROS, TenantSecurityConfig
from eros.core.types import (
    MemoryLayer, SignalType, BondedMemory, PADVector,
    ComputationFingerprint, ExperienceSignal, RiskLevel
)
from eros.core.persistence import EROSDatabase, InvertedIndex
from eros.core.memory import (
    CognitiveMemorySystem, SimpleEmbedder,
    RuleClassifier, WorkingMemory
)
from eros.core.eme import ExecutionMemoryEngine, GenericAdapter, CostBudget
from eros.core.bus import ExperienceBus, PADMonitor, Tier1Observer, BeliefRegistry
from eros.security.manager import SecurityManager, ContentFilter, ContentSensitivity, TenantSecurityConfig
from eros.observability.watchdog import Watchdog
from eros.observability.telemetry import Telemetry
...
from eros.llm.client import MockLLMClient
...
def test_pad_vector_severity():
    ...
    from eros.core.types import PADSeverity
...
def test_security_encryption():
    from eros.security.manager import SimpleEncryption
...
async def test_eros_with_mock_llm():
    mock = MockLLMClient()
    eros = EROS(
