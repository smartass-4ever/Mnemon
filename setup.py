...
setup(
    ...
    keywords=[
        ...
        "smolagents cache", "pydantic ai cache", "dspy cache", "agno cache",
        "mastra cache", "reduce gemini costs", "reduce llama costs",
        "python llm memoization", "llm call deduplication", "llm api bill",
        "production llm optimization", "llm agent production", "ai agent framework cache",
        "execution cache python", "semantic cache python", "llm caching library",
        "agent cost optimization", "llm api cost saving", "ai cost reduction tool",
        "llm agent speed", "fast llm agent", "zero token repeat runs",
        "agent workflow cache", "multi agent cache", "llm plan caching",
        "agentic plan caching", "neurips 2025 agent caching", "stanford llm research",
    ],
