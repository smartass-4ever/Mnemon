...
Translates CrewAI's native concepts into EROS signals:
...
Usage:
    from eros.adapters.crewai import CrewAIAdapter, wrap_crew

    adapter = CrewAIAdapter()
    eros = EROS(tenant_id="my_company", adapter=adapter)
"""
...
class CrewAIAdapter(TemplateAdapter):
    ...
    Translates:
    - CrewAI Task dicts → EROS ExecutionTemplates
    - CrewAI Agent configs → EROS memory signals
    - CrewAI outputs → EROS experience signals
